# Lab 04-05 — Advanced Integration

**Module:** 04 — Redis cache and session store  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-04-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect redis to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 04-01 through 04-04 pass
