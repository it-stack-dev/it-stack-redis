# Makefile — IT-Stack REDIS (Module 04)
...
build: ## Build Docker image
	docker build -t it-stack/redis:latest .
...
test-lab-03: ## Lab 03 — Advanced Features
	@bash tests/labs/test-lab-04-03.sh

test-lab-04: ## Lab 04 — SSO Integration
	@bash tests/labs/test-lab-04-04.sh

test-lab-05: ## Lab 05 — Advanced Integration
	@bash tests/labs/test-lab-04-05.sh

test-lab-06: ## Lab 06 — Production Deployment
	@bash tests/labs/test-lab-04-06.sh

deploy: ## Deploy to target server (lab-db1)
	ansible-playbook -i ansible/inventory.yml ansible/playbooks/deploy-redis.yml
